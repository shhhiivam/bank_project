...
$Status=$json['CustomerInfo']['AccountStatus'];
...
<body class=""> 
     ...
     <div class="w3-bar w3-dark-grey">
        ...
        <a href="login.php" class="w3-bar-item w3-button w3-light-grey">Login</a>
        <a href="php/registration.php" class="w3-bar-item w3-button ">Registration</a>
  ...
  ?>
    ...
    <div class="w3-card-4 w3-light-grey w3-third " style="margin-top:15%;margin-left:33%">
